@HomeworkScenario
Feature: 
  Techfios Other billing login page functionality validation
...
Scenario Outline: User should be able to login with valid credentials and open a new account	
	...
	|demo@techfios.com|abc123|CheckingAccount|CheckingAccountDescription|$50,000|023456789|MS|9876542100|www.Abcbank.com|
